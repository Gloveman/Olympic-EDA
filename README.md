...
인사이트: 이는 단순한 심리적 요인을 넘어, 개최국에게 부여되는 자동 출전권과 인프라 익숙도가 결합된 결과다. 하계 올림픽은 종목 수가 훨씬 많고 메달 외연 확장이 용이하여 국가적 역량 집중 시 '메달 퀀텀 점프'가 가능합니다. 반면, 동계 올림픽은 설질/빙질 등 특정 환경에 대한 숙련도가 필수적이라 단기간의 투자나 개최국 이점만으로는 성적을 급격히 끌어올리기 어렵다는 **'종목 진입 장벽'** 의 존재를 시사합니다.
